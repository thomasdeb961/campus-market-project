...
<div style="background: var(--card-bg); padding: 40px; border-radius: var(--radius); box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); width: 100%; max-width: 400px; text-align: center;">        
        <h1 style="font-size: 1.8rem; margin-bottom: 20px; color: var(--primary-color);">👋 Bon retour !</h1>
        ...
        <form method="POST" action="index.php?action=login" style="box-shadow: none; padding: 0; margin: 0; background: transparent;">
            ...
            <button type="submit" class="btn" style="width: 100%; font-size: 1.1rem;">Se connecter</button>
        </form>
        
        <div style="margin-top: 25px; border-top: 1px solid #e2e8f0; padding-top: 20px;">
            <p style="margin-bottom: 10px; font-size: 0.95rem;">Pas encore de compte ? <a href="index.php?action=register" style="color: var(--primary-color); font-weight: 600; text-decoration: none;">S'inscrire</a></p>
